...
\begin{center}
    \begin{tabular}{ |p{2em} c c| } \hline
        ...
        & \begin{minipage}{0.9\textwidth}
            Creates and initializes a \texttt{SendRequestException} with the provided message. \\
...
\begin{center}
    \begin{tabular}{ |p{2em} c c| } \hline
        ...
        & \begin{minipage}{0.9\textwidth}
            Creates and initializes a \texttt{ResponseException} with the provided message. \\
...
\begin{center}
    \begin{tabular}{ |p{2em} c c| } \hline
        ...
        \multicolumn{3}{|l|}{
            \begin{minipage}{{0.9\textwidth}}
                \mint[fontsize=\small]{java}|Drone(FeatureCollection noFlyZones)|
                \vspace{-0.5em}
            \end{minipage}
        } \\
    ...
    \begin{longtable}{ |p{2em} c c| } \hline
        ...
        & \begin{minipage}{0.9\textwidth}
            ...
            \begin{itemize}[label={}, topsep=0pt, itemsep=0pt]
                ...
                \item \texttt{noFlyZones}: the no-fly-zones the drone must avoid
            \end{itemize}
        \end{minipage} & \\ 
    ...
    \begin{longtable}{ |p{2em} c c| } \hline
        ...
        & \begin{minipage}{0.9\textwidth}
            ...
            \begin{itemize}[label={}, topsep=0pt, itemsep=0pt]
                ...
                \item \texttt{noFlyZones}: the list of no-fly-zones
            \end{itemize}
        \end{minipage} & \\
